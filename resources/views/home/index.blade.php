...
<section class="bg-indigo-600 py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="max-w-3xl text-left">
            ...
            <form action="{{ route('ahli.index') }}" method="GET">
                ...
                <button type="submit" class="absolute right-2 top-2 bottom-2 bg-indigo-600 text-white px-6 rounded-full font-bold hover:bg-indigo-700 transition-colors">
                    Cari Expert
                </button>
                </form>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                @foreach($categories as $kat)
                    <a href="{{ route('ahli.index', ['category' => $kat->id]) }}" class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md hover:border-indigo-500 transition-all group">
                        ...
                        <h3 class="font-bold text-gray-900 mb-1">{{ $kat->name }}</h3>
                        <p class="text-sm text-gray-500">Lihat Ahli</p>
                    </a>
                @endforeach
            </div>
        </div>
